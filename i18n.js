...
const I18N = {
  zh: {
    ...
    settings: {
      ...
      anthropicGuide: "Anthropic 指南",
      geminiGuide: "Google Gemini 指南",
      azureGuide: "Azure OpenAI 指南",
      ...
      testSkipped: "试用模式无需测试，可直接保存。",
      testFailed: "❌ 测试失败：",
      noApiKey: "请先输入 API Key",
      trialLocked: "试用模式下此项已锁定。如需自定义，请切换到 OpenAI/DeepSeek/Anthropic/Gemini/Azure/自定义。",
  ...
  en: {
    ...
    settings: {
      ...
      anthropicGuide: "Anthropic Guide",
      geminiGuide: "Google Gemini Guide",
      azureGuide: "Azure OpenAI Guide",
      ...
      testSkipped: "Trial mode does not require testing; you can save directly.",
      testFailed: "❌ Test failed:",
      noApiKey: "Please enter API Key first",
      trialLocked: "This item is locked in trial mode. To customize, please switch to OpenAI/DeepSeek/Anthropic/Gemini/Azure/Custom.",
